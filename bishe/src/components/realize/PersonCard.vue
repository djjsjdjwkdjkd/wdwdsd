  ...
  <div class="person_card_center">
    <el-row class="person_card_wrap" type="flex" justify="space-between">
      <el-col class="card_item" :span="11" :xs="24">
        ...
        <div class="card_desc">
          哈基米宠物创始人，担任公司董事长和法定代表人
          上海健康产业大数据技术联盟理事长 浙江省大健康产业联合会副理事长
          上海市“5050计划”认定海外高层次人才
          携团队获评2018年唯一的“上海市领军型青年创业团队”
          中国科技部城市竞争力研究院首届专家
        </div>
      </el-col>
      <el-col class="card_item" :span="11" :xs="24">
...
.person_card_center {
  ...
  .person_card_wrap {
    ...
    .card_item {
      background: url('../../assets/img/175745.png') 50% 50% no-repeat;
      background-size: cover;
      color: #fff;
      height: 400px;
      padding: 30px;
      &:nth-child(2){
        background: url('../../assets/img/0001654.png') 50% 50% no-repeat;
        background-size: cover;
        @media screen and (max-width: 768px) {
          margin-top: 1rem;
        }
