    ...
    <div class="repost_mobile_shiying">
      ...
      <div class="report_avtive_wrap" v-show="optionActive === 0">
        <div class="repost_tag_wrap hidden-xs-only">
          <span>因为爱，所以更懂健康——我们不仅是宠物用品的提供者，更是宠物健康生活的守护者，陪伴每一只小可爱度过健康、快乐的每一天！</span>
          ...
          <Tabs :value="activeIndex + ''" class="tabs_wrap" draggable style=" margin: 0 auto">
            <TabPane label="最新" name="0" class="tabs_item">
              <div class="book_content">
                <div class="book_item" v="(item, index)" key="index">
                  <div class="book_left">
                ...
                <div class="book_item" v="(item, index)" key="index">
                  <div class="book_left">
                    <img :src='"../../assets/img/wugui.png"'/>
                  </div>
                  <div class="book_right" @click="reportNavigate(item.report_id)">
                    <span >龟类健康养殖关键技术有问心答</span>
                  </div>
                </div>
              </div>
            </TabPane>
            <TabPane label="猫" name="1" class="tabs_item">
              <div class="book_content">
                <div class="book_item" v="(item, index)" key="index">
                  <div class="book_left">
                    <img :src='"../../assets/img/cat1.png"'/>
            ...
            <TabPane label="狗" name="2" class="tabs_item">
              <div class="book_content">
                <div class="book_item" v="(item, index)" key="index">
                  <div class="book_left">
                    <img :src='"../../assets/img/dog1.png"'/>
            ...
            <TabPane label="其他" name="3" class="tabs_item">
              <div class="book_content">
                <div class="book_item" v="(item, index)" key="index">
                  <div class="book_left">
                    <img :src='"../../assets/img/wugui.png"'/>
        ...
        <div class="book_list">
          ...
          <div class="book_list_scroll" ref="listScroll">
            <el-row class="card_list">
              <el-col class="card_item" v="(item, index)" key="index">
                  <div class="item_left">
                    <img :src='"../../assets/img/catfood1.png"' />
                  </div>
              </el-col>
              <el-col class="card_item" v="(item, index)" key="index">
                  <div class="item_left">
                    <img :src='"../../assets/img/catfood2.png"' />
                  </div>
              </el-col>
              <el-col class="card_item" v="(item, index)" key="index">
                  <div class="item_left">
                    <img :src='"../../assets/img/dogfood1.png"' />
                  </div>
                </el-col>
              <el-col class="card_item" v="(item, index)" key="index">
                  <div class="item_left">
                    <img :src='"../../assets/img/dogfood2.png"' />
                  </div>
                </el-col>
              <el-col class="card_item" v="(item, index)" key="index">
                  <div class="item_left">
                    <img :src='"../../assets/img/dogfood3.png"' />
                  </div>
              </el-col>
            </el-row>
        ...
        <div class="book_list">
          ...
          <div class="book_list_scroll" ref="listScroll2">
            <el-row class="card_list">
              <el-col class="card_item" v="(item, index)" key="index">
                  <div class="item_left">
                    <img :src='"../../assets/img/cattoy1.png"' />
                  </div>
              </el-col>
              <el-col class="card_item" v="(item, index)" key="index">
                  <div class="item_left">
                    <img :src='"../../assets/img/cattoy2.png"' />
                  </div>
              </el-col>
              <el-col class="card_item" v="(item, index)" key="index">
                  <div class="item_left">
                    <img :src='"../../assets/img/dogtoy1.png"' />
                  </div>
              </el-col>
              <el-col class="card_item" v="(item, index)" key="index">
                  <div class="item_left">
                    <img :src='"../../assets/img/dogtoy2.png"' />
                  </div>
              </el-col>
            </el-row>
            <div class="list_scroll_btn">
        ...
        <div class="book_list">
          ...
          <div class="book_list_scroll" ref="listScroll3">
            <el-row class="card_list">
              <el-col class="card_item" v="(item, index)" key="index">
                  <div class="item_left">
                    <img :src='"../../assets/img/maoshao1.png"' />
                  </div>
              </el-col>
              <el-col class="card_item" v="(item, index)" key="index">
                  <div class="item_left">
                    <img :src='"../../assets/img/maoshao2.png"' />
                  </div>
              </el-col>
              <el-col class="card_item" v="(item, index)" key="index">
                  <div class="item_left">
                    <img :src='"../../assets/img/maoshao3.png"' />
                  </div>
              </el-col>
            </el-row>
            <div class="list_scroll_btn">
